...
Static Function SPFatImp03(lEnd, cArq)
	...
	If !File(cArq)
		MsgStop("O arquivo "  + cArq + " nÃ£o foi encontrado. A importaÃ§Ã£o serÃ¡ abortada!","ATENCAO")
		Return
	EndIf
 
	FT_FUSE(cArq) //Lê o arquivo de texto
    ...
    For nx := 1 To Len(aDados)
        ...
        aAdd(aAuto,{'B1_IPI'     ,Alltrim(U_NEWGENASP(aDados[nx][3]))                                                        ,Nil})
