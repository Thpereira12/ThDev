...
User Function SPIMP05()
    ...
    If ParamBox({	{6,"Selecione Arquivo",PadR("",150),"",,"", 90 ,.T.,"Importação Titulos a Receber","",GETF_LOCALHARD+GETF_LOCALFLOPPY+GETF_NETWORKDRIVE}},;
            "Importacao Titulos a Receber SP Acos",@aRet)
...
//--------------------------------------------------
	...
	Retorna codigo do cliente atual, a partir do codigo legado
