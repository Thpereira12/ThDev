...
User Function SPIMP01()
    ...
    If ParamBox({	{6,"Selecione Arquivo",PadR("",150),"",,"", 90 ,.T.,"Importação Fornecedores","",GETF_LOCALHARD+GETF_LOCALFLOPPY+GETF_NETWORKDRIVE}},;
            "Importação Fornecedores SP Aços",@aRet)
...
Static Function SPFatImp01(lEnd, cArq)
    ...
    For nx := 1 To Len(aDados)
        ...
        aAdd(aAuto,{'A2_NREDUZ'  ,Alltrim(U_NEWGENASP(aDados[nx][16]))                                                      ,Nil})
        aAdd(aAuto,{'A2_NOME'    ,Alltrim(aDados[nx][17])                                                                   ,Nil})
        ...
        Else
            ...
            Conout("Fornecedor incluio com sucesso!")
