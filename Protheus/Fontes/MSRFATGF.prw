...
User Function MSRFATGF(lAuto,cNumero)
	...
	cQuery += "       C5_PARC2,C6_PEDCLI,C5_PARC3,C5_PARC4,C5_CLIENTE,C5_LOJACLI,C5_ZZCDCT," + CRLF
...
//				oPrint:Say(nTopo + 0057,nInicio + 0600, Substr(AllTrim(QRY->C6_OBS),nTamStr,30)		,oFont2,100,,,0)
		...
		If nCont > nCount
			...
			oPrint:Say((Mm2Pix(oPrint, oPrint:nVertSize()) + 0180)-050,nInicio + 2360,"Página: " + Str(nPage) + " / " + AllTrim(nQtdPag)  ,oFont3,100,,,1)
...
Static Function getIpiValue(nOption, aAliquota)
	...
	If cCalcIPI == "S"
		...
		// Calcula o Valor Total do Orçamento de Venda com IPI
...
Static Function PrintTrailer(nPage,nTotal,nTopo)
	...
	If nTopo <= (Mm2Pix(oPrint, oPrint:nVertSize()) - 0600)
		...
		// Titulo Centralizado
		oPrint:Say(Mm2Pix(oPrint, oPrint:nVertSize()) - 1230, Mm2Pix(oPrint, oPrint:nHorzSize()) / 2,"Informações Gerais",oFont1,100,,,2)
		...
		oPrint:Say(Mm2Pix(oPrint, oPrint:nVertSize()) - 0950,nInicio + 0060,"Nº do Pedido Cliente" 				 				,oFont3,100,,,0)
...
//		oPrint:Say(Mm2Pix(oPrint, oPrint:nVertSize()) - 0550, Mm2Pix(oPrint, oPrint:nHorzSize()) / 2 + 0250,": " + Dtoc(QRY->C5_VALIDA),oFont5,100,,,0)
		...
		cMemo := Posicione("ZB7",1,xFilial("ZB7") + QRY->C5_ZZCDCT,"ZB7_MEMO")
		...
		// Imprime o Numero de Paginas
		//oPrint:Say(Mm2Pix(oPrint, oPrint:nVertSize()) - 0050,nInicio + 2360,"Página: " + Str(nPage) + " / " + AllTrim(nQtdPag)   ,oFont3,100,,,1)
...
//		oPrint:Say(Mm2Pix(oPrint, oPrint:nVertSize()) - 0550, Mm2Pix(oPrint, oPrint:nHorzSize()) / 2 + 0250,": " + Dtoc(QRY->C5_VALIDA),oFont5,100,,,0)
		...
		// Imprime o Numero de Paginas
		oPrint:Say(Mm2Pix(oPrint, (oPrint:nVertSize()) - 0000) - 250,nInicio + 2360,"Página: " + Str(nPage) + " / " + AllTrim(nQtdPag),oFont3,100,,,1)
...
/*
*	Função responsável pelo retorno dos impostos.
*/
